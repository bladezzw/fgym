...
del data_3['Adj Close']

start_date = '2005-01-01'
end_date='2016-01-01'
train_data = data_3[(data_3.Date > start_date) & (data_3.Date < end_date)]
...
for j in trange(len(Date)):
    ...
    if date >= Date[windows-1]:
        ...
        for i in range(len(select_stocks_list)):
            ...
            data_list.append(np.array(temp_tics_data.iloc[iloc-windows+1:iloc+1,-4:]))
